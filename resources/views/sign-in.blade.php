...
<div class="h-full">
    <div class="px-view py-view mx-auto">
        ...
        <form id="authenticate_form" class="bg-white shadow rounded-lg p-8 max-w-login mx-auto" method="POST" action="{{ route('nova-two-factor.auth') }}">
            ...
            <h2 class="text-2xl text-center font-normal mb-6 text-90">Autenticação de dois fatores</h2>
            ...
            @endif
            <div class="mb-6 ">
                <label class="block font-bold mb-2" for="password">Código de autenticação</label>
